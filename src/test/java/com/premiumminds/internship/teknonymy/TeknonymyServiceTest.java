...
public void PersonFullTest() {
    Person person = new Person(
            ...
            new Person[]{
                    ...
                    new Person("Dolores", 'F', null, LocalDateTime.of(1948, 1, 1, 0, 0)),
            }, LocalDateTime.of(1946, 1, 1, 0, 0));
    String resultado = new TeknonymyService().getTeknonymy(person);
    String esperado = "great-great-great-great-grandfather of Marco";
